  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p @click="changeDefaultAddress(userAddressList,address)">
          <span class="s1">{{ address.fullAddress }}</span>
          <span class="s2">{{ address.phoneName }}</span>
...
export default {
  ...
  methods: {
    ...
    changeDefaultAddress(userAddressList, address) {
